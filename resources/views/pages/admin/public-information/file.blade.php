            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header-left">
                        <h5 class="text-uppercase title">File Informasi Publik</h5>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="file">File Informasi Publik</label>
...
@push('scripts')
    ...
    <script>
        ...
        let public_information_news_id = pathSegments[pathSegments.length - 2];
        $(function() {
            dataTable(public_information_news_id);
        })
        ...
        function back() {
            window.location.href = "{{ route('public-information-news') }}"
        }

        function dataTable(pubic_information_news_id) {
            const url = `/api/admin/public-information-file/${pubic_information_news_id}/datatable`;
        ...
        function getData(id) {
            $.ajax({
                url: `/api/admin/public-information-file/${id}/detail`,
                method: "GET",
                dataType: "json",
        ...
        $("#formEditable form").submit(function(e) {
            ...
            formData.append("public_information_news_id", public_information_news_id);
        ...
        function saveData(data, action) {
            $.ajax({
                url: action == "update" ? "/api/admin/public-information-file/update" : "/api/admin/public-information-file/create",
                contentType: false,
                processData: false,
                method: "POST",
                data: data,
        ...
        function removeData(id) {
            ...
            if (c) {
                $.ajax({
                    url: "/api/admin/public-information-file",
                    method: "DELETE",
                    data: {
                        id: id
                    },
